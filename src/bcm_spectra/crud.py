...
def add_scan_to_run(session: Session, run: Run, scan_number, ms_level, mz_array, intensity_array, other_info):
    scan = Scan(scan_number=scan_number, ms_level=ms_level, mz_array=mz_array, intensity_array=intensity_array, other_info=other_info, run=run)
