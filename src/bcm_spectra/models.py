...
from sqlalchemy import create_engine, Column, Integer, Float, String, ForeignKey, JSON, LargeBinary
...
class Scan(Base):
    ...
    intensity_array = Column(LargeBinary) # this actually a blob we need to define encoding
